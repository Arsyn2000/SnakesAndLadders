# Text based snakes and ladders game

import time
import random
import sys

# Adding a delay of 1 second before performing any action
SLEEP_BETWEEN_ACTIONS = 1
MAX_VAL = 100
DICE_FACE = 6

# Key value pair for snakes. Snake takes you down from 'key' to 'value'
snakes = {
    8: 4,
    18: 1,
    26: 10,
...
# Key value pair for ladders. Ladder take you up from 'key' to 'value'
ladders = {
    3: 20,
    6: 14,
    11: 28,
...
def get_player_name():
    ...
    print("Match will be palyed between ", player1_name, " and ", player2_name)
...
def get_snake_bite(old_value, current_value, player_name):
...
def snake_ladder(player_name, current_value, dice_value):
    ...
    if current_value > MAX_VAL:
        ...
        if current_value in snakes:
            ...
            get_snake_bite(current_value, final_value, player_name)
...
def start():
    ...
    while True:
        time.sleep(SLEEP_BETWEEN_ACTIONS)
        input1 = input(player1_name + ":" + random.choice(player_turn_text)+ "\nHit enter to roll the dice")
        print("\nRolling Dice...")
        ...
        input2 = input(player2_name + ":" + random.choice(player_turn_text) + "\nHit enter to roll the dice")
        print("\nRolling Dice...")
        dice_value = get_dice_value()
        time.sleep(SLEEP_BETWEEN_ACTIONS)
